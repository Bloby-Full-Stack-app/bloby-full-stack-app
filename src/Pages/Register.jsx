...
function Register() {
    ...
    const handleSubmit = async (event) => {
        ...
        const promise = dispatch(register({
            username: username,
            email: email,
            password: password,
                            ...
                            <div className="sign__content">
                                <form onSubmit={handleSubmit} className="sign__form">
                                    ...
                                    <div className="sign__group">
                                        <input type="text" className="sign__input" placeholder="Username" value={username}
                                    ...
                                    <div className="sign__group">
                                        <input type="password" className="sign__input" placeholder="Password" value={password}
                                            onChange={e => setPassword(e?.target?.value)} />
                                    </div>
                                    <div className="sign__group">
                                        <input type="password" className="sign__input" placeholder="Confirm password" value={confirmPassword}
                                            onChange={e => setConfirmPassword(e?.target?.value)} />
                                    </div>
                                    <ul className="sign__radio" style={{ marginBottom: '10px', flexDirection: 'row', justifyContent: 'space-evenly' }}>
                                    ...
                                    <div className="sign__group sign__group--checkbox">
                                        ...
                                        <label>I agree to the <a href="privacy.html">Privacy Policy</a></label>
                                    </div>
