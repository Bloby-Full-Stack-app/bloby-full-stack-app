						...
						<div class="sign__content">
							<form action="#" class="sign__form">
								<div class="sign__group">
									<input type="text" class="sign__input" placeholder="Firstname" />
								</div>
                                <div class="sign__group">
									<input type="text" class="sign__input" placeholder="Lastname" />
								</div>
                                <div class="sign__group">
								...
								<span class="sign__text">Already have an account? <Link to="/login">Sign in!</Link></span>
							</form>
						</div>
					</div>
				</div>
