...
function Single(props) {
    return (
        <li className="single-item">
            ...
            <a data-link data-title="Cinematic" data-artist="AudioPizza" data-img="assets/img/covers/cover1.jpg" href="http://blast.volkovdesign.com/audio/12071151_epic-cinematic-trailer_by_audiopizza_preview.mp3" className="single-item__cover">
            ...
            <div className="single-item__title">
                <h4><a href="#">{props.artist}</a></h4>
                <span><a href="artist.html">{props.title}</a></span>
            </div>
